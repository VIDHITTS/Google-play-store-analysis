  ...
  return (
    <div className="min-h-screen p-4 md:p-8 flex items-center justify-center">
      <div className="w-full max-w-4xl slide-up-fade">
        ...
        {/* Footer */}
        <footer className="text-center mt-8 space-y-1 text-sm text-muted-foreground">
          <p className="font-medium">Powered by K-Nearest Neighbors Machine Learning</p>
          <p className="text-xs">Predictions based on Google Play Store historical data</p>
        </footer>
      </div>
    </div>
  );
